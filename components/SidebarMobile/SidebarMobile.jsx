...
const SidebarHomeMobile = ({
  ...
  // useEffect(() => {
  //   // Kiểm tra điều kiện kích thước màn hình trước khi thực hiện các hàm
  //   if (window.innerWidth < 768) {
  //     // Gọi các hàm hoặc thực hiện các công việc mong muốn ở đây
  //     console.log("Mounted and screen size is less than 768px");
  //   }

  //   // Clean up function nếu cần
  //   return () => {
  //     // Thực hiện các công việc dọn dẹp khi component unmount
  //   };
  ...
  if (window.innerWidth < 768) {
    ...
    `}
        ...
        >
          <div
            className="absolute top-0 right-0 z-[100] cursor-pointer"
            onClick={(e) => {
              console.log("suu");
          ...
          >
            <span className="flex justify-center items-center text-white bg-[rgba(255,255,255,0.4)] hover:bg-[rgba(255,255,255,0.8)] w-[30px] h-[30px] z-[100]">
              {/* <i className="fa-solid fa-xmark text-[30px]"></i> */}
              <i className="fa-solid fa-chevron-left text-[25px] z-[100]"></i>
            </span>
          </div>
        </div>
        ...
        <div
          className={`${
            showSideBarMobile
              ? "left-0 opacity-90 w-[350px] visible"
